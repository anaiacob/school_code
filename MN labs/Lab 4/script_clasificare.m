...
N2 = 50;        % numar puncte in a doua clasa
...
V1 = iris_data(1 : 50, 2 : 3)';
% V2 = c2 + s2*randn(ell,N2);
V2 = iris_data(51 : 100, 2 : 3)';

V3 = iris_data(101 : 150, 2 : 3)';
...
hold on
plot(V3(1,:), V3(2,:), '*g', 'LineWidth', 2, 'MarkerSize', 10)
...
hold on
if abs(c(2)) > abs(c(1))
  plot([-1 10], -1/c(2)*(c(1)*[0 10] + d), 'g', 'LineWidth', 2)
else
