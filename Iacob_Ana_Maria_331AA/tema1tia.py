...
try:
    ...
    print("Pachetul 'stopwords' din NLTK nu a fost gasit. Se descarca acum...")
    nltk.download('stopwords')
    stop_words = set(stopwords.words('english'))
    print("Descarcare finalizata.")
...
try:
    ...
    print(f"Eroare: Fisierul '{file_name}' nu a fost gasit. Asigurati-va ca este in aceeasi locatie cu scriptul.")
    exit()
except ImportError:
...
if df.shape[1] >= 5:
    ...
    df.columns = ['label', 'message']
    print("Fisierul nu continea coloane suplimentare, doar 'label' si 'message' (v1 si v2).")
